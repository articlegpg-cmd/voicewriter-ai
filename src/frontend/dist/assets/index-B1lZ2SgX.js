...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 bg-card border-b border-border shadow-sm px-4 py-3 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-semibold text-foreground tracking-tight", children: "ভয়েস রাইটার" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto pb-20", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-0 left-0 right-0 z-30 bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-stretch h-16 max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NavTab,
        {
          to: "/",
          label: "রেকর্ড",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { size: 22 }),
          active: currentPath === "/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        NavTab,
        {
          to: "/history",
          label: "ইতিহাস",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 22 }),
...
function NavTab({ to, label, icon, active, dataOcid }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      to,
      className: `flex-1 flex flex-col items-center justify-center gap-1 transition-colors duration-200 ${active ? "text-primary" : "text-muted-foreground hover:text-foreground"}`,
      "data-ocid": dataOcid,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium font-body", children: label }),
        active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 h-0.5 w-10 rounded-full bg-primary" })
      ]
    }
  );
}
...
const CreateRecordingRequest = Record({
  "title": Text,
  "audioBlobRef": Text,
  "language": Text,
  "durationSeconds": Float64
});
const RecordingId = Nat;
const UserId = Principal$1;
const Timestamp = Int;
const TranscriptStatus$1 = Variant({
  "pending": Null,
  "error": Null,
  "complete": Null,
  "processing": Null
...
const RecordingInfo = Record({
  ...
  "durationSeconds": Float64,
  "transcript": Text,
  "transcriptStatus": TranscriptStatus$1
});
const RefineMode$1 = Variant({
  "summarize": Null,
  "grammarFix": Null,
  "rewrite": Null,
  "removeFiller": Null
});
const RefineRequest = Record({
  "mode": RefineMode$1,
  "text": Text
});
const RefineResult = Record({ "refinedText": Text });
...
const UpdateTranscriptRequest = Record({
  "id": RecordingId,
  "status": TranscriptStatus$1,
  "transcript": Text
});
Service({
  "createRecording": Func([CreateRecordingRequest], [RecordingInfo], []),
  "deleteRecording": Func([RecordingId], [Bool], []),
  "getRecording": Func([RecordingId], [Opt(RecordingInfo)], ["query"]),
  "listRecordings": Func([], [Vec(RecordingInfo)], ["query"]),
  "refineText": Func([RefineRequest], [RefineResult], []),
  "transcribeRecording": Func([RecordingId], [Bool], []),
  "transform": Func(
    [TransformationInput],
    [TransformationOutput],
    ["query"]
  ),
  "updateRecordingTitle": Func([RecordingId, Text], [Bool], []),
  "updateTranscript": Func([UpdateTranscriptRequest], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const CreateRecordingRequest2 = IDL2.Record({
    "title": IDL2.Text,
    "audioBlobRef": IDL2.Text,
    "language": IDL2.Text,
    "durationSeconds": IDL2.Float64
  });
  const RecordingId2 = IDL2.Nat;
  const UserId2 = IDL2.Principal;
  const Timestamp2 = IDL2.Int;
  const TranscriptStatus2 = IDL2.Variant({
    "pending": IDL2.Null,
    "error": IDL2.Null,
    "complete": IDL2.Null,
  ...
  const RefineMode2 = IDL2.Variant({
    "summarize": IDL2.Null,
    "grammarFix": IDL2.Null,
    "rewrite": IDL2.Null,
    "removeFiller": IDL2.Null
  });
  const RefineRequest2 = IDL2.Record({ "mode": RefineMode2, "text": IDL2.Text });
  const RefineResult2 = IDL2.Record({ "refinedText": IDL2.Text });
  ...
  const UpdateTranscriptRequest2 = IDL2.Record({
    "id": RecordingId2,
    "status": TranscriptStatus2,
    "transcript": IDL2.Text
  });
  return IDL2.Service({
    "createRecording": IDL2.Func([CreateRecordingRequest2], [RecordingInfo2], []),
    "deleteRecording": IDL2.Func([RecordingId2], [IDL2.Bool], []),
    "getRecording": IDL2.Func(
      [RecordingId2],
      [IDL2.Opt(RecordingInfo2)],
      ["query"]
    ),
    "listRecordings": IDL2.Func([], [IDL2.Vec(RecordingInfo2)], ["query"]),
    "refineText": IDL2.Func([RefineRequest2], [RefineResult2], []),
    "transcribeRecording": IDL2.Func([RecordingId2], [IDL2.Bool], []),
    "transform": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    ),
    "updateRecordingTitle": IDL2.Func([RecordingId2, IDL2.Text], [IDL2.Bool], []),
    "updateTranscript": IDL2.Func([UpdateTranscriptRequest2], [IDL2.Bool], [])
  });
};
class Backend {
  ...
  async transcribeRecording(arg0) {
    if (this.processError) {
      try {
  ...
  async updateRecordingTitle(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_RecordingInfo_n1(_uploadFile, _downloadFile, value) {
  return from_candid_record_n2(_uploadFile, _downloadFile, value);
}
function from_candid_TranscriptStatus_n3(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n4(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "error" in value ? "error" : "complete" in value ? "complete" : "processing" in value ? "processing" : value;
}
...
function to_candid_RefineMode_n9(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function to_candid_RefineRequest_n7(_uploadFile, _downloadFile, value) {
  return to_candid_record_n8(_uploadFile, _downloadFile, value);
}
function to_candid_TranscriptStatus_n13(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateTranscriptRequest_n11(_uploadFile, _downloadFile, value) {
...
function useUpdateRecordingTitle() {
  const { actor } = useBackendActor();
  const qc = useQueryClient();
  return useMutation({
...
function useTranscribeRecording() {
  const { actor } = useBackendActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (id) => {
...
var RefineMode = /* @__PURE__ */ ((RefineMode2) => {
  RefineMode2["summarize"] = "summarize";
  RefineMode2["grammarFix"] = "grammarFix";
  RefineMode2["rewrite"] = "rewrite";
  RefineMode2["removeFiller"] = "removeFiller";
  return RefineMode2;
})(RefineMode || {});
var TranscriptStatus = /* @__PURE__ */ ((TranscriptStatus2) => {
  TranscriptStatus2["pending"] = "pending";
  TranscriptStatus2["error"] = "error";
  TranscriptStatus2["complete"] = "complete";
  TranscriptStatus2["processing"] = "processing";
  return TranscriptStatus2;
})(TranscriptStatus || {});
var jt = (n) => {
  switch (n) {
    case "success":
...
export {
  ...
  Mic as M,
  RefineMode as R,
  TranscriptStatus as T,
  useTranscribeRecording as a,
  useRefineText as b,
  ...
  buttonVariants as h,
  useListRecordings as i,
  useDeleteRecording as j,
  Clock as k,
  useUpdateRecordingTitle as l,
  useCreateRecording as u
};
